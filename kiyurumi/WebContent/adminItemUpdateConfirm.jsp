...
<h1>商品更新確認画面</h1>
	<div id="contents">
		...
		<s:form action="AdminItemUpdateCompleteAction">
			<table class="vertical-list-table"  border="1">
				...
				<tr>
					...
					<td><s:property value="itemImageFileName"/>
						<s:hidden name="itemImageFileName" value="%{itemImageFileName}"/>
					</td>
				</tr>
				<tr>
					<th scope="row"><s:label value="画像"/></th>
					<td>
						<img src="images/<s:property value="itemImageFileName"/>" width="300" height="300" />
					</td>
				</tr>
				<tr>
