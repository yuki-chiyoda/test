...
//		もし、ログインIDが重複していてかつ、入力したidとsessionのid(もともとのID)が同じなら重複エラーリストは消す。

		if(!(loginIdCheckMessageList.isEmpty()) && userId.equals(session.get("userId").toString())){
			loginIdCheckMessageList.clear();
		}
