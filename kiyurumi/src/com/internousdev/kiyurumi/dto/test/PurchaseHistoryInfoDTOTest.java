...
public class PurchaseHistoryInfoDTOTest {
	...
	@Test
	public void testgetBirthPlace8() {
		PurchaseHistoryInfoDTO dto = new PurchaseHistoryInfoDTO();
		String expected = "ａｂｃ１２３あいう漢字";
		dto.setBirthPlace(expected);
	...
	@Test
	public void testsetBirthPlace8() {
		PurchaseHistoryInfoDTO dto = new PurchaseHistoryInfoDTO();
		String expected = "ａｂｃ１２３あいう漢字";
		dto.setBirthPlace(expected);
	...
	@Test
	public void testGetBirthDate2() throws ParseException{
		PurchaseHistoryInfoDTO dto = new PurchaseHistoryInfoDTO();

		String expected =null;
		dto.setBirthDate(expected);
		assertEquals(expected,dto.getBirthDate());
	}
	...
	@Test
	public void testSetBirthDate2() throws ParseException{
		PurchaseHistoryInfoDTO dto = new PurchaseHistoryInfoDTO();
